...
import { mapModelToClaudeModel, resolveClaudeExecutableAsync, isClosedControllerError, hasExtendedContext, stripExtendedContext } from "./models"
  ...
  const handleMessages = async (
    ...
    return withClaudeLogContext({ requestId: requestMeta.requestId, endpoint: requestMeta.endpoint }, async () => {
      try {
        ...
        let model = mapModelToClaudeModel(body.model || "sonnet")
