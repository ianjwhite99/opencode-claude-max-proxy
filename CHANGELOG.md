...
## [1.12.0](https://github.com/ianjwhite99/opencode-claude-max-proxy/compare/v1.11.2...v1.12.0) (2026-03-21)


### Features

* add build pipeline for npm publishing, remove runtime Bun dependency ([a296d56](https://github.com/ianjwhite99/opencode-claude-max-proxy/commit/a296d56d41047e86e733c447622c1fd4c8bcbb8c))
...
* restore concurrency queue, idle timeout, and Docker crash recovery ([06a3bf3](https://github.com/ianjwhite99/opencode-claude-max-proxy/commit/06a3bf3c31759f8bedab30e0ac6d6c1dbd856f63))
...
* skip postbuild hook in Docker to prevent proxy starting during build ([34f0acd](https://github.com/ianjwhite99/opencode-claude-max-proxy/commit/34f0acd911ad43d3251617286e68c5e6160f357c))
* skip postbuild hook in Docker to prevent proxy starting during build ([7e96af5](https://github.com/ianjwhite99/opencode-claude-max-proxy/commit/7e96af5dc1932c3cb936b83d86e26a76ae995f3c))
...
* use sh instead of bash in docker-entrypoint for Alpine ([a953adb](https://github.com/ianjwhite99/opencode-claude-max-proxy/commit/a953adbca0967480bda3ece3d559882d66445ba8))
* use sh instead of bash in docker-entrypoint for Alpine compatibility ([b9bddbd](https://github.com/ianjwhite99/opencode-claude-max-proxy/commit/b9bddbd832c9d2620ad358a158dd6d371db9e839))
